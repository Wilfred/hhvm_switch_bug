<?hh // strict
	...
	type my_test_shape = shape(
		...
		?'bOhr6OSu0LHEF5XqYqGZUMYXg80C1Ip5' => bool,
		?'bz5KZwUt4ki8N1D1L4iUIJzp2MPVnZlu' => bool,
		?'k5aLd9eaTZNZR0Rc7ox4JFkLoOUgCxYv' => bool,
		?'A5IfgAbbnM1BRKHavPbC3vwYZFDFjEom' => string,
		?'ARRm1Mtqg2MX85hms2JvvJTHElRZSpK7' => bool,
		?'cPIBtP19A77sikxQ1R0U5QxEzXXPH1i3' => bool,
		?'xUGMW1f9RuUZBgbwFrPtQYp4F56PQDpI' => bool,
		?'rmheb2pmGN7ymFmwhmv9f2wGZhrqbwKp' => bool,
		?'cRseROPz9fPqOyeb1VQuD7kYkuMYtfHn' => bool,
		?'I7QD8Fy32hCarkT8c6rBdpdTc4pIOUUl' => bool,
		?'CusAsrLGWY8h00dMIePGnhd2fG237Y1N' => bool,
		?'VqgpxbrCX0yDsBMQ4kWggY7eo7QiJ2DB' => bool,
		?'pQzBQgqJQ9RryvFGWvYvBibmm14OOiO5' => bool,
		?'O9ZDZQIDLAwhUkvdVVl8p8tDCCjOaims' => string,
		?'pzFzWMyWLEPSpVihsK7otAW8F5XVRGk5' => string,
		?'KKpXLNGcAPCz7VJ4CRED1lGRtKJJ6FK1' => bool,
		?'JGFYDHIaTfIQceyenkTo69p7StsgreH8' => bool,
		...
		?'hGVouDzs3f9GVx5iMDvJZ7p4ttGWTO78' => bool,
		?'YLz5q56Ao5Dk9ro8qscJUIUvQTzo9Nfd' => bool,
		?'Nk9Kfl3pujBZs8VyWJYzIDQ54hAKR2xk' => string,
		?'tn0J5un2qttFuX9jgIEHH3aiApBXfEAh' => int,
		?'Z11JabAEK3ReXuPw7SZVcGhpKx3G0Fsu' => bool,
		?'EWSOJawdlPNS58riJgKT1xAQDrTgcdXw' => bool,
		?'gwICIrn0uwABfiUunZVx2sfXvTUeumaZ' => bool,
		?'YewwiqiePdwIAiTxR4CMWPKpF8fCse4r' => bool,
		...
		?'L4CIUXn6uSXC59kCBMzV27HbxchlyXvM' => ?bool,
		...
		?'RxmY1605vVWjVcQZF7opd2NsJmX8vmh0' => string,
		?'r8TSJUEoYz6q9yzMLX568YcO3PilcSxq' => string,
		?'WbAXIoh0zXE3WsTiXrMAoW9p6xYqT8fT' => bool,
		...
		?'N4Lrabm7SsuRV8Jzb8cv5ylHnb3X3Uks' => bool,
		...
		?'RS9uGAuCtltZky7tYnJZ0rdvLjC9ljub' => bool,
		?'qBcAMFifpyEsAn2iRZXTluFshLQiLGwj' => ?string,
		...
		?'nZQELai7GXmGnuIcrtUC1syJZcDODRfn' => string,
		?'PfyGpARJLJCq9dXipmmtJ3zjkL5r5bG9' => bool,
		?'cJkFmZww16GAsNihluGXKD4g4BHhi9fZ' => bool,
		?'Qqow2BysqZIrMLhj7GDCB7aekpt0FZ6T' => bool,
		?'K3alidCHVISpVk9AHcTXJvFPR4zzdyJF' => bool,
		?'PGiQzuvo1QdeWytniVR0yKodGBsN9FXO' => bool,
		...
		?'DxSOUBvZQUAFDbHaAk2QpeF9CTuDDzXH' => bool,
		?'EaQy6hVli0Tt1cSOzd6HjU7reZagnH2o' => bool,
		?'howen40z05mLIyzCnJH1TJsD1DcFEI2N' => bool,
		?'Euh1xMMDXjjoJ0Q53B10IOhx8tNZh7wB' => string,
		?'cvqy5lgmvLQDe2X9mAXgNZc8O94mQPIO' => string,
		?'RIkPUEcctBTBr2o5ilSgnnc4KJU2TDKV' => bool,
		...
		?'AWzqPCpfJ4ohzwXGjnDplmc7R1ugaPMv' => bool,
		?'f73nxtG3btozbJd4bRkRlSB0yUm736hG' => bool,
	...
	function bind_mixed_array_to_shape(array<string, mixed> $input): my_test_shape {
		...
		foreach ($input as $key => $val){
			switch ($key){
				...
				case 'BisHXEcgEf8KqMtcdrwvjr53fPFMXpCh':
						...
						break;
				case 'fGOKF5NcYLd4iTdDNZElgUcwyx4zyFfP':
						$out['fGOKF5NcYLd4iTdDNZElgUcwyx4zyFfP'] = is_null($val) ? null : (string)$val;
						break;
				...
				case 'buJSs2Wru4Ib1pxYhT2wmF4fuOYw04WE':
						...
						break;
				case 'tgmpjP6akWmdPZnBWOp0l9vJ0YEgxzAV':
						$out['tgmpjP6akWmdPZnBWOp0l9vJ0YEgxzAV'] = (bool)$val;
						break;
				case 'VpuEIcgztCPWWfxrGNQSFCvPfygy66gf':
						$out['VpuEIcgztCPWWfxrGNQSFCvPfygy66gf'] = (bool)$val;
						break;
				case 'bOhr6OSu0LHEF5XqYqGZUMYXg80C1Ip5':
						$out['bOhr6OSu0LHEF5XqYqGZUMYXg80C1Ip5'] = (bool)$val;
						break;
				case 'bz5KZwUt4ki8N1D1L4iUIJzp2MPVnZlu':
						$out['bz5KZwUt4ki8N1D1L4iUIJzp2MPVnZlu'] = (bool)$val;
						break;
				case 'k5aLd9eaTZNZR0Rc7ox4JFkLoOUgCxYv':
						$out['k5aLd9eaTZNZR0Rc7ox4JFkLoOUgCxYv'] = (bool)$val;
						break;
				case 'A5IfgAbbnM1BRKHavPbC3vwYZFDFjEom':
						$out['A5IfgAbbnM1BRKHavPbC3vwYZFDFjEom'] = (string)$val;
						break;
				case 'ARRm1Mtqg2MX85hms2JvvJTHElRZSpK7':
						$out['ARRm1Mtqg2MX85hms2JvvJTHElRZSpK7'] = (bool)$val;
						break;
				case 'cPIBtP19A77sikxQ1R0U5QxEzXXPH1i3':
						$out['cPIBtP19A77sikxQ1R0U5QxEzXXPH1i3'] = (bool)$val;
						break;
				case 'xUGMW1f9RuUZBgbwFrPtQYp4F56PQDpI':
						$out['xUGMW1f9RuUZBgbwFrPtQYp4F56PQDpI'] = (bool)$val;
						break;
				case 'rmheb2pmGN7ymFmwhmv9f2wGZhrqbwKp':
						$out['rmheb2pmGN7ymFmwhmv9f2wGZhrqbwKp'] = (bool)$val;
						break;
				case 'cRseROPz9fPqOyeb1VQuD7kYkuMYtfHn':
						$out['cRseROPz9fPqOyeb1VQuD7kYkuMYtfHn'] = (bool)$val;
						break;
				case 'I7QD8Fy32hCarkT8c6rBdpdTc4pIOUUl':
						$out['I7QD8Fy32hCarkT8c6rBdpdTc4pIOUUl'] = (bool)$val;
						break;
				case 'CusAsrLGWY8h00dMIePGnhd2fG237Y1N':
						$out['CusAsrLGWY8h00dMIePGnhd2fG237Y1N'] = (bool)$val;
						break;
				case 'VqgpxbrCX0yDsBMQ4kWggY7eo7QiJ2DB':
						$out['VqgpxbrCX0yDsBMQ4kWggY7eo7QiJ2DB'] = (bool)$val;
						break;
				case 'pQzBQgqJQ9RryvFGWvYvBibmm14OOiO5':
						$out['pQzBQgqJQ9RryvFGWvYvBibmm14OOiO5'] = (bool)$val;
						break;
				case 'O9ZDZQIDLAwhUkvdVVl8p8tDCCjOaims':
						$out['O9ZDZQIDLAwhUkvdVVl8p8tDCCjOaims'] = (string)$val;
						break;
				case 'pzFzWMyWLEPSpVihsK7otAW8F5XVRGk5':
						$out['pzFzWMyWLEPSpVihsK7otAW8F5XVRGk5'] = (string)$val;
						break;
				case 'KKpXLNGcAPCz7VJ4CRED1lGRtKJJ6FK1':
						$out['KKpXLNGcAPCz7VJ4CRED1lGRtKJJ6FK1'] = (bool)$val;
						break;
				case 'JGFYDHIaTfIQceyenkTo69p7StsgreH8':
						$out['JGFYDHIaTfIQceyenkTo69p7StsgreH8'] = (bool)$val;
						break;
				case 'ftGMe49Orc6YYjIcIhJfPGat3URWvJIK':
						$out['ftGMe49Orc6YYjIcIhJfPGat3URWvJIK'] = (bool)$val;
						break;
				case 'NyiCoO1icuiYJUzX8pJOcyL57aORodtg':
						$out['NyiCoO1icuiYJUzX8pJOcyL57aORodtg'] = (bool)$val;
						break;
				...
				case 'Q5QCgQjzNFOJV38d34L3IQ3kQ9FQn324':
						...
						break;
				case 'wGaul0yI7n7OTQyBt7cAGEmlgC2MMBRD':
						$out['wGaul0yI7n7OTQyBt7cAGEmlgC2MMBRD'] = (bool)$val;
						break;
				case 'z9USzNLMlCiAsTMsCnBHl3Wagn7zMfeP':
						$out['z9USzNLMlCiAsTMsCnBHl3Wagn7zMfeP'] = (bool)$val;
						break;
				case 'fJiSycuX4hRcTDAWlT2krYJGDK7YzHEI':
						$out['fJiSycuX4hRcTDAWlT2krYJGDK7YzHEI'] = (bool)$val;
						break;
				...
				case 'dEuG9fA3sSFkRYale1SiZ9Q8EwxMSsje':
						...
						break;
				case 'zXjOqKVd5iY67J5S2buQuQFvHAhsfHsq':
						$out['zXjOqKVd5iY67J5S2buQuQFvHAhsfHsq'] = (bool)$val;
						break;
				...
				case 'uSRy67Feo4hdtBrAlCsttOSi8SVeu9Gr':
						...
						break;
				case 'qbiphchBWSTnXLdYg4BNoMMXRCBMrsme':
						$out['qbiphchBWSTnXLdYg4BNoMMXRCBMrsme'] = (bool)$val;
						break;
				case 'qbh3i0gpdJaKIIarKCyN1HBjUAz8TNqq':
						$out['qbh3i0gpdJaKIIarKCyN1HBjUAz8TNqq'] = (bool)$val;
						break;
				case 'hGVouDzs3f9GVx5iMDvJZ7p4ttGWTO78':
						$out['hGVouDzs3f9GVx5iMDvJZ7p4ttGWTO78'] = (bool)$val;
						break;
				case 'YLz5q56Ao5Dk9ro8qscJUIUvQTzo9Nfd':
						$out['YLz5q56Ao5Dk9ro8qscJUIUvQTzo9Nfd'] = (bool)$val;
						break;
				case 'Nk9Kfl3pujBZs8VyWJYzIDQ54hAKR2xk':
						$out['Nk9Kfl3pujBZs8VyWJYzIDQ54hAKR2xk'] = (string)$val;
						break;
				case 'tn0J5un2qttFuX9jgIEHH3aiApBXfEAh':
						$out['tn0J5un2qttFuX9jgIEHH3aiApBXfEAh'] = intval($val);
						break;
				case 'Z11JabAEK3ReXuPw7SZVcGhpKx3G0Fsu':
						$out['Z11JabAEK3ReXuPw7SZVcGhpKx3G0Fsu'] = (bool)$val;
						break;
				case 'EWSOJawdlPNS58riJgKT1xAQDrTgcdXw':
						$out['EWSOJawdlPNS58riJgKT1xAQDrTgcdXw'] = (bool)$val;
						break;
				case 'gwICIrn0uwABfiUunZVx2sfXvTUeumaZ':
						$out['gwICIrn0uwABfiUunZVx2sfXvTUeumaZ'] = (bool)$val;
						break;
				case 'YewwiqiePdwIAiTxR4CMWPKpF8fCse4r':
						$out['YewwiqiePdwIAiTxR4CMWPKpF8fCse4r'] = (bool)$val;
						break;
				case 'rb17NdpTAocqk5gI1OpMZUVxHuJCRE9a':
						$out['rb17NdpTAocqk5gI1OpMZUVxHuJCRE9a'] = (bool)$val;
						break;
				case 'CrnFkv60EIzoLM8shJtGg4yQAa61LstL':
						$out['CrnFkv60EIzoLM8shJtGg4yQAa61LstL'] = (bool)$val;
						break;
				...
				case 'QSJdc80ARaeY4coksYDsH6YnpCwvpHHR':
						...
						break;
				case 'h8hZnsFQwHxesqNeKqdQiQXyIG7rw7Sp':
						$out['h8hZnsFQwHxesqNeKqdQiQXyIG7rw7Sp'] = (bool)$val;
						break;
				...
				case 'eKfA04BQcK2m7XtJKbYzGdFqbcyNFDkT':
						...
						break;
				case 'hjCrytsxQMwlPXII2LgkgQavFPlhWquw':
						$out['hjCrytsxQMwlPXII2LgkgQavFPlhWquw'] = (bool)$val;
						break;
				case 'j8XiLmYR867vRVkmXr13ZFeLzZRG34FG':
						$out['j8XiLmYR867vRVkmXr13ZFeLzZRG34FG'] = intval($val);
						break;
				case 'L4CIUXn6uSXC59kCBMzV27HbxchlyXvM':
						$out['L4CIUXn6uSXC59kCBMzV27HbxchlyXvM'] = is_null($val) ? null : (bool)$val;
						break;
				case 'h7lonLWSnfIqQTLIR3pMGk8DYLI1Y1Hq':
						$out['h7lonLWSnfIqQTLIR3pMGk8DYLI1Y1Hq'] = is_null($val) ? null : (string)$val;
						break;
				case 'lseb0ODUBQ1PFanHwWH3wrDnCbuGDNeT':
						$out['lseb0ODUBQ1PFanHwWH3wrDnCbuGDNeT'] = is_null($val) ? null : (string)$val;
						break;
				...
				case 'KInPsIMdO0d57yqC3G1O0GY1DJwxLyiD':
						...
						break;
				case 'OJZXjd65IsN6XHUxDn1sKAHzzjsexVma':
						$out['OJZXjd65IsN6XHUxDn1sKAHzzjsexVma'] = (bool)$val;
						break;
				case 'FTeaTYrNZiq8Yr8qhb1MyB9yp0hxIeVI':
						$out['FTeaTYrNZiq8Yr8qhb1MyB9yp0hxIeVI'] = (bool)$val;
						break;
				case 'RxmY1605vVWjVcQZF7opd2NsJmX8vmh0':
						$out['RxmY1605vVWjVcQZF7opd2NsJmX8vmh0'] = (string)$val;
						break;
				case 'r8TSJUEoYz6q9yzMLX568YcO3PilcSxq':
						$out['r8TSJUEoYz6q9yzMLX568YcO3PilcSxq'] = (string)$val;
						break;
				case 'WbAXIoh0zXE3WsTiXrMAoW9p6xYqT8fT':
						$out['WbAXIoh0zXE3WsTiXrMAoW9p6xYqT8fT'] = (bool)$val;
						break;
				case 'R7AgBWOj4CeyutCmGSLB9j2BSjrV3oZ3':
						$out['R7AgBWOj4CeyutCmGSLB9j2BSjrV3oZ3'] = (bool)$val;
						break;
				case 'DQfwNU1xKdFC8qzjao1qStaICGU7Ri3J':
						$out['DQfwNU1xKdFC8qzjao1qStaICGU7Ri3J'] = intval($val);
						break;
				...
				case 'S7vrT7mMqLMQfPUJz1NY535UzYomKKiy':
						...
						break;
				case 'qrYpnWfyOTyjkN8IusQiWcw84P8uwJ3R':
						$out['qrYpnWfyOTyjkN8IusQiWcw84P8uwJ3R'] = (bool)$val;
						break;
				...
				case 'EvNFKq1qBSz2Gz0KiOX8ZYpXEJXsqoGx':
						...
						break;
				case 'hfxnyorr8OaSY3qyj8oZlKqZPtRZ70pv':
						$out['hfxnyorr8OaSY3qyj8oZlKqZPtRZ70pv'] = (bool)$val;
						break;
				case 'kCwKwRnFh47TTY2m2WjVIrYLfyXF0MLi':
						$out['kCwKwRnFh47TTY2m2WjVIrYLfyXF0MLi'] = (bool)$val;
						break;
				case 'N4Lrabm7SsuRV8Jzb8cv5ylHnb3X3Uks':
						$out['N4Lrabm7SsuRV8Jzb8cv5ylHnb3X3Uks'] = (bool)$val;
						break;
				case 'gTksiBDATqK9JZFk9DLxVvPqO3XJe5XI':
						$out['gTksiBDATqK9JZFk9DLxVvPqO3XJe5XI'] = (bool)$val;
						break;
				case 'OwTzpFTehtwgUg0ESdMrx5rGhxiPxfo8':
						$out['OwTzpFTehtwgUg0ESdMrx5rGhxiPxfo8'] = (bool)$val;
						break;
				...
				case 'I0qNPWVYJfKvD6aL1srr9NRB6b9MkBuB':
						...
						break;
				case 'eScWxitr7MPaxiB9MoXZXF1vzpF7saJS':
						$out['eScWxitr7MPaxiB9MoXZXF1vzpF7saJS'] = (bool)$val;
						break;
				case 'bng4CinfkLcfVP1wgOyWeOMYGwYOJWBh':
						$out['bng4CinfkLcfVP1wgOyWeOMYGwYOJWBh'] = (bool)$val;
						break;
				case 'RjprGtwQvBkEvtb04EiBZtBbobID5N8O':
						$out['RjprGtwQvBkEvtb04EiBZtBbobID5N8O'] = (bool)$val;
						break;
				case 'hMhVdO7G6rrE6CEK5gyKeYzHF51mwoh2':
						$out['hMhVdO7G6rrE6CEK5gyKeYzHF51mwoh2'] = is_null($val) ? null : (string)$val;
						break;
				...
				case 'H8EXdGfGOV6Uu5oNVQaIpXcRwMChMaO8':
						...
						break;
				case 'tpIt48pxJVOgo8PPeZmhyqOZt4VaSVyf':
						$out['tpIt48pxJVOgo8PPeZmhyqOZt4VaSVyf'] = (bool)$val;
						break;
				case 'slBD2iWeh1KN3PqTKEYOPcnphvHhte5S':
						$out['slBD2iWeh1KN3PqTKEYOPcnphvHhte5S'] = (string)$val;
						break;
				case 'RS9uGAuCtltZky7tYnJZ0rdvLjC9ljub':
						$out['RS9uGAuCtltZky7tYnJZ0rdvLjC9ljub'] = (bool)$val;
						break;
				case 'qBcAMFifpyEsAn2iRZXTluFshLQiLGwj':
						$out['qBcAMFifpyEsAn2iRZXTluFshLQiLGwj'] = is_null($val) ? null : (string)$val;
						break;
				case 'CSjtyrql18p6SAwVgn1YfYZG5w9EcVX0':
						$out['CSjtyrql18p6SAwVgn1YfYZG5w9EcVX0'] = is_null($val) ? null : (string)$val;
						break;
				case 'q7pX7lQtdxI2JuCZiGTBSr3Zk8HLtCej':
						$out['q7pX7lQtdxI2JuCZiGTBSr3Zk8HLtCej'] = (bool)$val;
						break;
				...
				case 'NwXRkjl6NGAvdt8aZV5nDav3jd12h60Q':
						...
						break;
				case 's8CaBvz8seo2JuPZ4PVyh26x20iwSPYp':
						$out['s8CaBvz8seo2JuPZ4PVyh26x20iwSPYp'] = (string)$val;
						break;
				case 'b7YxNl9ZqPHjHn6sqPPMvzKTFgPQggl9':
						$out['b7YxNl9ZqPHjHn6sqPPMvzKTFgPQggl9'] = (bool)$val;
						break;
				case 'nZQELai7GXmGnuIcrtUC1syJZcDODRfn':
						$out['nZQELai7GXmGnuIcrtUC1syJZcDODRfn'] = (string)$val;
						break;
				case 'PfyGpARJLJCq9dXipmmtJ3zjkL5r5bG9':
						$out['PfyGpARJLJCq9dXipmmtJ3zjkL5r5bG9'] = (bool)$val;
						break;
				case 'cJkFmZww16GAsNihluGXKD4g4BHhi9fZ':
						$out['cJkFmZww16GAsNihluGXKD4g4BHhi9fZ'] = (bool)$val;
						break;
				case 'Qqow2BysqZIrMLhj7GDCB7aekpt0FZ6T':
						$out['Qqow2BysqZIrMLhj7GDCB7aekpt0FZ6T'] = (bool)$val;
						break;
				case 'K3alidCHVISpVk9AHcTXJvFPR4zzdyJF':
						$out['K3alidCHVISpVk9AHcTXJvFPR4zzdyJF'] = (bool)$val;
						break;
				case 'PGiQzuvo1QdeWytniVR0yKodGBsN9FXO':
						$out['PGiQzuvo1QdeWytniVR0yKodGBsN9FXO'] = (bool)$val;
						break;
				case 'LKuXyEdSEqD90TPY1iU6bYJVngAOekNz':
						$out['LKuXyEdSEqD90TPY1iU6bYJVngAOekNz'] = (bool)$val;
						break;
				case 'WMtn25bxvLVOnANRl5HQRVOB9kthOYS2':
						$out['WMtn25bxvLVOnANRl5HQRVOB9kthOYS2'] = (string)$val;
						break;
				...
				case 'ioJL3TVEgwFPUsFWEtBCJl01MYOucMc0':
						...
						break;
				case 'd183DPE1GwTNrZZQHWBDoXo1Pq6bka0A':
						$out['d183DPE1GwTNrZZQHWBDoXo1Pq6bka0A'] = (bool)$val;
						break;
				...
				case 'OCfVGv1G4dzyz6AdXYCihh6RirI8L3ID':
						...
						break;
				case 'mVBYYZMZOsemdNaDgOgegb8R2oXIl4K5':
						$out['mVBYYZMZOsemdNaDgOgegb8R2oXIl4K5'] = (bool)$val;
						break;
				case 'Pq3oOmA7QnTnWkrSdOoe4mBmsQIts3co':
						$out['Pq3oOmA7QnTnWkrSdOoe4mBmsQIts3co'] = (bool)$val;
						break;
				case 'DxSOUBvZQUAFDbHaAk2QpeF9CTuDDzXH':
						$out['DxSOUBvZQUAFDbHaAk2QpeF9CTuDDzXH'] = (bool)$val;
						break;
				case 'EaQy6hVli0Tt1cSOzd6HjU7reZagnH2o':
						$out['EaQy6hVli0Tt1cSOzd6HjU7reZagnH2o'] = (bool)$val;
						break;
				case 'howen40z05mLIyzCnJH1TJsD1DcFEI2N':
						$out['howen40z05mLIyzCnJH1TJsD1DcFEI2N'] = (bool)$val;
						break;
				case 'Euh1xMMDXjjoJ0Q53B10IOhx8tNZh7wB':
						$out['Euh1xMMDXjjoJ0Q53B10IOhx8tNZh7wB'] = (string)$val;
						break;
				case 'cvqy5lgmvLQDe2X9mAXgNZc8O94mQPIO':
						$out['cvqy5lgmvLQDe2X9mAXgNZc8O94mQPIO'] = (string)$val;
						break;
				case 'RIkPUEcctBTBr2o5ilSgnnc4KJU2TDKV':
						$out['RIkPUEcctBTBr2o5ilSgnnc4KJU2TDKV'] = (bool)$val;
						break;
				case 'iZbaP9ecViiXwfdKkqSXKK0YA9GctJja':
						$out['iZbaP9ecViiXwfdKkqSXKK0YA9GctJja'] = intval($val);
						break;
				case 'i4sTQTtLRphHzeFb2syxOdAKyUY2nWnI':
						$out['i4sTQTtLRphHzeFb2syxOdAKyUY2nWnI'] = (bool)$val;
						break;
				...
				case 'hfRiybhZMzwc1FmHyfUGUtOR1PtNwc2G':
						...
						break;
				case 'jPEyQUcbdVbwSIvF0NB0JbMsEiMUAZqw':
						$out['jPEyQUcbdVbwSIvF0NB0JbMsEiMUAZqw'] = (bool)$val;
						break;
				...
				case 'gigP8WKpdsbUlK2p2zhsSsEct1sbkYc6':
						...
						break;
				case 'P1gpTYN4dO9z8SQJSLcCOaNoWbHWw7W6':
						$out['P1gpTYN4dO9z8SQJSLcCOaNoWbHWw7W6'] = intval($val);
						break;
				case 'K8XkcMUVJCRrYyqhsQhO0gCoLtPdhBSu':
						$out['K8XkcMUVJCRrYyqhsQhO0gCoLtPdhBSu'] = (string)$val;
						break;
				case 'iHKdDDnS80NpHAcmhkFhuMSjLj1yahXP':
						$out['iHKdDDnS80NpHAcmhkFhuMSjLj1yahXP'] = (bool)$val;
						break;
				case 'z0FqpvKDbnnkgSd9YJP1djqfbMHrBFSf':
						$out['z0FqpvKDbnnkgSd9YJP1djqfbMHrBFSf'] = (string)$val;
						break;
				...
				case 'ZQvjhiaSydE9Ka3ccImlC0CgGdTUIhSZ':
						...
						break;
				case 'q7D9ZFlR2ap34E1iDTrIElQPec6hTsaS':
						$out['q7D9ZFlR2ap34E1iDTrIElQPec6hTsaS'] = (bool)$val;
						break;
				case 'fjzmSwD73KbH1AewDgTJK8XDOBAH3jxo':
						$out['fjzmSwD73KbH1AewDgTJK8XDOBAH3jxo'] = intval($val);
						break;
				case 'knsSU1MR9iFgoJmNS7usXn33QiuxBf2K':
						$out['knsSU1MR9iFgoJmNS7usXn33QiuxBf2K'] = (string)$val;
						break;
				...
				case 'iwAChDxI4Hm19nA1WVJDpfvtz8LEkpwa':
						...
						break;
				case 'DTLi3jXmMtXFHAuGcUkc0zjCPXiIhqc0':
						$out['DTLi3jXmMtXFHAuGcUkc0zjCPXiIhqc0'] = (string)$val;
						break;
				...
				case 'Qm8d6T2iYMXqSB5Wfrt5OtWSOcOaRY4h':
						...
						break;
				case 'ndaubVYTp9Uevneoyey0N7RfP6BPA6sC':
						$out['ndaubVYTp9Uevneoyey0N7RfP6BPA6sC'] = (string)$val;
						break;
				case 'Hn4SacF28E2qMZEi32YRpW64eKwtzUDe':
						$out['Hn4SacF28E2qMZEi32YRpW64eKwtzUDe'] = (string)$val;
						break;
				case 'AWzqPCpfJ4ohzwXGjnDplmc7R1ugaPMv':
						$out['AWzqPCpfJ4ohzwXGjnDplmc7R1ugaPMv'] = (bool)$val;
						break;
				case 'f73nxtG3btozbJd4bRkRlSB0yUm736hG':
						$out['f73nxtG3btozbJd4bRkRlSB0yUm736hG'] = (bool)$val;
						break;
				case 'BlKPuO9gZQj3SjhQCcDskNc1xPCCBrn1':
						$out['BlKPuO9gZQj3SjhQCcDskNc1xPCCBrn1'] = intval($val);
						break;
				case 'AZIM3t9nLSbn7V1YLDWTEJ2ML26rF4Nn':
						$out['AZIM3t9nLSbn7V1YLDWTEJ2ML26rF4Nn'] = (bool)$val;
						break;
				...
				case 'VhzJCyPVxO9BSbqx0iYqHAHAGgCXSA6D':
						...
						break;
				case 'Jo4iCjgrXtWoP2wsRKKTEvcCUu2UG6bJ':
						$out['Jo4iCjgrXtWoP2wsRKKTEvcCUu2UG6bJ'] = intval($val);
						break;
				...
				case 'FGFI2Bqb54huxf41ZbxbBV7QMEGLyQJz':
						...
						break;
				case 'sg539t2DGmdv7XALjryKQ1IJXMz2LxVe':
						$out['sg539t2DGmdv7XALjryKQ1IJXMz2LxVe'] = (string)$val;
						break;
				case 'SL8klPYDpGXLCxOYGtdblPquLwbsogCM':
						$out['SL8klPYDpGXLCxOYGtdblPquLwbsogCM'] = (bool)$val;
						break;
				case 'oKYM31E6SBqVvSE86Dy79an5EgfkAdoI':
						$out['oKYM31E6SBqVvSE86Dy79an5EgfkAdoI'] = (bool)$val;
						break;
				case 'EzSGYEDcjDCZWMd4BQ0hxdG7q7LrvInw':
						$out['EzSGYEDcjDCZWMd4BQ0hxdG7q7LrvInw'] = (bool)$val;
						break;
				...
				case 'n6N42FLNTLuvGFE1xUjap7wqwGpKPJhH':
						...
						break;
				case 'OaaL7bRwU1ku2XXGuQaSXr4yOHFGlb4W':
						$out['OaaL7bRwU1ku2XXGuQaSXr4yOHFGlb4W'] = (bool)$val;
						break;
				case 'g6wTFWQtw6nQfSUm51MvWi8ngZndBe8W':
						$out['g6wTFWQtw6nQfSUm51MvWi8ngZndBe8W'] = (bool)$val;
						break;
				case 'Lfhh27II1xmVGldsj5HLMsNZiAf6N8dK':
						$out['Lfhh27II1xmVGldsj5HLMsNZiAf6N8dK'] = intval($val);
						break;
				...
				case 'Zvs7j22zzmqKcA50pTVxq9R4Bpr0FRZW':
						...
						break;
				case 'hcQztJbqWhxP3MmVvyYhK5Da4rGRqWTZ':
						$out['hcQztJbqWhxP3MmVvyYhK5Da4rGRqWTZ'] = (string)$val;
						break;
				...
				case 'Tsf1CdHumGwJtWsYdsAyTwBp4EJ3Uhfp':
						...
						break;
				case 'RXx4Q64ogw01U6lcpw90o2avGMlopuxg':
						$out['RXx4Q64ogw01U6lcpw90o2avGMlopuxg'] = (string)$val;
						break;
				case 'pdOr66tUpWtjHW2QDEsgW93H4HC0KkEP':
						$out['pdOr66tUpWtjHW2QDEsgW93H4HC0KkEP'] = (string)$val;
						break;
				case 'SUMjODhXA2GkzcMBMubpaXtg0Ghtp6QN':
						$out['SUMjODhXA2GkzcMBMubpaXtg0Ghtp6QN'] = (string)$val;
						break;
				...
				case 'edgRnGg1ZuVtxxoOGyoMRWWA0Pd7FKrX':
						...
						break;
				case 'ExU9NL4skrWDr9NG6NtA9OB40MIwgbu7':
						$out['ExU9NL4skrWDr9NG6NtA9OB40MIwgbu7'] = intval($val);
						break;
				case 'otJWI1OtudINLdasqOvedSmkQsVz1kw5':
						$out['otJWI1OtudINLdasqOvedSmkQsVz1kw5'] = intval($val);
						break;
				...
				case 'VP43GGOTymEJabMbh1BSwcDrmjxQkIzd':
						...
						break;
				case 'FnkkhCOC8GatJEcBsuwVekejE8S9CA4E':
						$out['FnkkhCOC8GatJEcBsuwVekejE8S9CA4E'] = intval($val);
						break;
				case 'r7IxfEMPM1EjQRU9L7Yy8Y2uIg8KaSzE':
						$out['r7IxfEMPM1EjQRU9L7Yy8Y2uIg8KaSzE'] = (string)$val;
						break;
				case 'Uus0ooK8tZu5VnlCE9MGsnDpUNpIACwK':
						$out['Uus0ooK8tZu5VnlCE9MGsnDpUNpIACwK'] = (string)$val;
						break;
				case 'DpoRL4CGHq1FJug8cRqAQCt5axghholS':
						$out['DpoRL4CGHq1FJug8cRqAQCt5axghholS'] = (bool)$val;
						break;
				...
				case 'tFeVluydTcaFnoc2jAG3g8zBjI7Ry1nC':
						...
						break;
				case 'SvDNRpePKnHdNEnT4V9wJ4yjfTpLxZa0':
						$out['SvDNRpePKnHdNEnT4V9wJ4yjfTpLxZa0'] = (bool)$val;
						break;
				case 'oOarhAhg46nB9aXAsmykZXHlWX82FhpG':
						$out['oOarhAhg46nB9aXAsmykZXHlWX82FhpG'] = (bool)$val;
						break;
				case 'vv57PYNCurDhZevC2RQigiy6yKIpNurK':
						$out['vv57PYNCurDhZevC2RQigiy6yKIpNurK'] = (bool)$val;
						break;
				case 'dMcb4ziLfDptIObdvT3HHLKUx9AzrDoc':
						$out['dMcb4ziLfDptIObdvT3HHLKUx9AzrDoc'] = (bool)$val;
						break;
				...
				case 'FMw4N5qXQyoA88OB1I3QrWZtpExhhO9z':
						...
						break;
				case 'jHW6mkgup0d45qfQkeLdd81Gr8kOlOUb':
						$out['jHW6mkgup0d45qfQkeLdd81Gr8kOlOUb'] = (string)$val;
						break;
				case 'nMbrqK8WzfZ6Re8vH4lgHDnNAyIvnGoK':
						$out['nMbrqK8WzfZ6Re8vH4lgHDnNAyIvnGoK'] = (bool)$val;
						break;
				default:
					// skip unknown keys
					break;
